...
where report = '1'
and a.season = 'fall' and a.year = '2023'
and a.styp_code = 'n'
and a.UOPI_status in ('not UOPI','integrated accelerator')
and b.season = 'fall' and b.year = '2023' )
...
select 'SAT' as TEST,
    PERC25_RW, PERC50_RW, PERC75_RW, PERC25_Math, PERC50_Math, PERC75_Math, PERC25_Comp, PERC50_Comp, PERC75_Comp,  count(*) as Count
    from SATPERC WITH (NOLOCK)
group by PERC25_RW, PERC50_RW, PERC75_RW, PERC25_Math, PERC50_Math, PERC75_Math, PERC25_Comp, PERC50_Comp, PERC75_Comp

UNION ALL

select 'ACT' as TEST,
    PERC25_RW, PERC50_RW, PERC75_RW, PERC25_Math, PERC50_Math, PERC75_Math, PERC25_Comp, PERC50_Comp, PERC75_Comp,  count(*) as Count
    from ACTPERC WITH (NOLOCK)
group by PERC25_RW, PERC50_RW, PERC75_RW, PERC25_Math, PERC50_Math, PERC75_Math, PERC25_Comp, PERC50_Comp, PERC75_Comp