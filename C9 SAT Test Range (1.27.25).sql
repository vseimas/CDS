...
---       count(case when Test_Score in ('SAT','Both') then pidm_key END) AS SATTestStu,
---       sum(case when SATV_Range = '700-800' then 1 else 0 END) As SATV_TOTAL,
       format(cast(sum(case when SATV_Range = '700-800' then 1 else 0 END) *100.00 / count(case when Test_Score in ('SAT','Both') then PIDM_KEY END) as decimal(10,5)), '0.00') AS SATV_PERC,
---       sum(case when SATM_Range = '700-800' then 1 else 0 END) As SATM_TOTAL,
       format(cast(sum(case when SATM_Range = '700-800' then 1 else 0 END) *100.00 / count(case when Test_Score in ('SAT','Both') then PIDM_KEY END) as decimal (10,5)), '0.00') AS SATM_PERC
...
---       count(PIDM_KEY) AS EnrStu,
---       count(case when Test_Score in ('SAT','Both') then pidm_key END) AS SATTestStu,
---       sum(case when SATV_Range = '600-699' then 1 else 0 END) As SATV_TOTAL,
       format(cast(sum(case when SATV_Range = '600-699' then 1 else 0 END) *100.00 / count(case when Test_Score in ('SAT','Both') then PIDM_KEY END) as decimal(10,5)), '0.00') AS SATV_PERC,
---       sum(case when SATM_Range = '600-699' then 1 else 0 END) As SATM_TOTAL,
       format(cast(sum(case when SATM_Range = '600-699' then 1 else 0 END) *100.00 / count(case when Test_Score in ('SAT','Both') then PIDM_KEY END) as decimal (10,5)), '0.00') AS SATM_PERC
...
---       count(PIDM_KEY) AS EnrStu,
---       count(case when Test_Score in ('SAT','Both') then pidm_key END) AS SATTestStu,
---       sum(case when SATV_Range = '500-599' then 1 else 0 END) As SATV_TOTAL,
       format(cast(sum(case when SATV_Range = '500-599' then 1 else 0 END) *100.00 / count(case when Test_Score in ('SAT','Both') then PIDM_KEY END) as decimal(10,5)), '0.00') AS SATV_PERC,
---       sum(case when SATM_Range = '500-599' then 1 else 0 END) As SATM_TOTAL,
       format(cast(sum(case when SATM_Range = '500-599' then 1 else 0 END) *100.00 / count(case when Test_Score in ('SAT','Both') then PIDM_KEY END) as decimal (10,5)), '0.00') AS SATM_PERC
...
---       count(PIDM_KEY) AS EnrStu,
---       count(case when Test_Score in ('SAT','Both') then pidm_key END) AS SATTestStu,
---       sum(case when SATV_Range = '400-499' then 1 else 0 END) As SATV_TOTAL,
       format(cast(sum(case when SATV_Range = '400-499' then 1 else 0 END) *100.00 / count(case when Test_Score in ('SAT','Both') then PIDM_KEY END) as decimal(10,5)), '0.00') AS SATV_PERC,
---       sum(case when SATM_Range = '400-499' then 1 else 0 END) As SATM_TOTAL,
       format(cast(sum(case when SATM_Range = '400-499' then 1 else 0 END) *100.00 / count(case when Test_Score in ('SAT','Both') then PIDM_KEY END) as decimal (10,5)), '0.00') AS SATM_PERC
...
---       count(PIDM_KEY) AS EnrStu,
---       count(case when Test_Score in ('SAT','Both') then pidm_key END) AS SATTestStu,
---       sum(case when SATV_Range = '300-399' then 1 else 0 END) As SATV_TOTAL,
       format(cast(sum(case when SATV_Range = '300-399'then 1 else 0 END) *100.00 / count(case when Test_Score in ('SAT','Both') then PIDM_KEY END) as decimal(10,5)), '0.00') AS SATV_PERC,
---       sum(case when SATM_Range = '300-399' then 1 else 0 END) As SATM_TOTAL,
       format(cast(sum(case when SATM_Range = '300-399' then 1 else 0 END) *100.00 / count(case when Test_Score in ('SAT','Both') then PIDM_KEY END) as decimal (10,5)), '0.00') AS SATM_PERC
...
---       count(PIDM_KEY) AS EnrStu,
---       count(case when Test_Score in ('SAT','Both') then pidm_key END) AS SATTestStu,
---       sum(case when SATV_Range = '200-299' then 1 else 0 END) As SATV_TOTAL,
       format(cast(sum(case when SATV_Range = '200-299' then 1 else 0 END) *100.00 / count(case when Test_Score in ('SAT','Both') then PIDM_KEY END) as decimal(10,5)), '0.00') AS SATV_PERC,
---       sum(case when SATM_Range = '200-299' then 1 else 0 END) As SATM_TOTAL,
       format(cast(sum(case when SATM_Range = '200-299' then 1 else 0 END) *100.00 / count(case when Test_Score in ('SAT','Both') then PIDM_KEY END) as decimal (10,5)), '0.00') AS SATM_PERC
